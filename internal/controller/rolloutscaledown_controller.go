...
// RolloutScaleDownReconciler reconciles a RolloutScaleDown object
type RolloutScaleDownReconciler struct {
	client.Client
...
// the RolloutScaleDown object against the actual cluster state, and then
...
func (r *RolloutScaleDownReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&rolloutv1alpha1.RolloutScaleDown{}).
		Complete(r)
}
